"""автообновление базы мемов при добавлении новых картинок
сканирует data/raw/new/ на новые изображения
аннотирует через gpt vision (10 полей), переводит search_queries на ru
кодирует через bge-m3, добавляет в три faiss индекса
перемещает обработанные файлы в data/raw/processed_new/
поддерживает incremental добавление без перестройки индексов
"""
