...
фильтрация по стоп-словам длине и confidence
"""
...
log.info(f"удалено conf={stats['removed_confidence']} len={stats['removed_length']} bad_word={stats['removed_bad_word']}")
log.info(f"рез {OUTPUT_FILE}")
