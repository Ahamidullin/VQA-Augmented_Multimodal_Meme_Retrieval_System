...
\begin{itemize}
    \item Formal validation of VQA annotation quality: manual review of a representative sample with inter-annotator agreement metrics, comparison against ground-truth captions (CER/WER for OCR, accuracy for tone/objects).
    ...
    \item Load/latency stress testing and monitoring setup.
